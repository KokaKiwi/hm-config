...
let
  ...
  lua = luajit.override {
    ...
    version = "2.1.ROLLING-unstable-2024-11-28";

    src = fetchFromGitHub {
      owner = "LuaJIT";
      repo = "LuaJIT";
      rev = "19878ec05c239ccaf5f3d17af27670a963e25b8b";
      hash = "sha256-EHpDXyyr4tWdPEOXE+AKdpjTi3zTsY0auyer4B3PDKg=";
    };
  };
...
in (neovim-unwrapped.override {
  ...
  version = "nightly-unstable-2024-12-15";

  src = fetchFromGitHub {
    owner = "neovim";
    repo = "neovim";
    rev = "852b6a6bcee56dc3d6c0f18f3e0119e3ffd682cc";
    hash = "sha256-gT5JE4FhITlvjuc7KMKnt/lfqXYaWUz4suN/02fyvWM=";
  };
